...
class BdmTemplate extends StatefulWidget {
  @override
  _BdmTemplateState createState() => _BdmTemplateState();
}

class _BdmTemplateState extends State<BdmTemplate> {
  final formkey = GlobalKey<FormState>();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("BDM Template"),
      ),
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: "ASK  1(exa:spicy foods you like)",
                    errorBorder: OutlineInputBorder(
                        borderSide:
                            new BorderSide(color: Colors.red, width: 2.0)),
                    enabledBorder: OutlineInputBorder(
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: "ASK  2(exa:category of games )",
                    errorBorder: OutlineInputBorder(
                        borderSide:
                            new BorderSide(color: Colors.red, width: 2.0)),
                    enabledBorder: OutlineInputBorder(
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: "ASK  3(exa:comedy movies  at their best)",
                    errorBorder: OutlineInputBorder(
                        borderSide:
                            new BorderSide(color: Colors.red, width: 2.0)),
                    enabledBorder: OutlineInputBorder(
